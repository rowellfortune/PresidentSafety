...
// At the top, add KatanaPIM API configuration
// define('KATANA_API_KEY', '549703c3-d73a-4c0b-8e15-0a25569bece2');
// define('KATANA_API_URL', 'https://schoononline.katanapim.com/api/v1/Product?Paging.DefaultPageSize=100&Paging.PageSize=100');

// Configuration
$baseUrl   = "https://<yourdomain>.katanapim.com/api/v1/Product";
$apiKey    = "549703c3-d73a-4c0b-8e15-0a25569bece2";  // Your KatanaPIM API key
$page      = 1;
$pageSize  = 100;              // Assuming 100 per page (adjust if needed or if API returns a different default)
$matchedProducts = [];
